  ...
  <div className={styles.div}>
    ...
    <div className={styles.box3}>
      <div className={styles.box}>
        ...
        <div className={styles.checkboxs1}>
          ...
          <label htmlFor="checkbox" className={styles.checkbox}>
            <input className={styles.checkbox} type="checkbox" id="checkbox2" />
            비동의
          </label>
        </div>
      </div>
      ...
      <div className={styles.box2}>
        ...
        <div className={styles.checkboxs1}>
          <label htmlFor="checkbox" className={styles.label}>
            <input className={styles.checkbox} type="checkbox" id="checkbox3" />
            (필수)동의
            </label>
          <label htmlFor="checkbox" className={styles.checkbox}>
            <input className={styles.checkbox} type="checkbox" id="checkbox4" />
            비동의
          </label>
        </div>
      </div>
