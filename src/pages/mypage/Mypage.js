                        ...
                        <div className={contentStyle.tableDiv}>
                            <ul className={contentStyle.ul2}>
                                <li className={contentStyle.tli2}>
                                    <img className={contentStyle.itemImgSize} src={artsy[20]?.imgUrl} alt="" />
                                    <p className={contentStyle.li}>
                                        {artsy[20]?.artist}
                                        <p className={contentStyle.titleText}>{`${artsy[20]?.title} / ${artsy[20]?.date}`}</p>
                            ...
                            <ul className={contentStyle.ul2}>
                                <li className={contentStyle.tli2}>
                                    <img className={contentStyle.itemImgSize} src={artsy[1]?.imgUrl} alt="" />
                                    <p className={contentStyle.li}>
                                        {artsy[1]?.artist}
                                        <p className={contentStyle.titleText}>{`${artsy[1]?.title} / ${artsy[1]?.date}`}</p>
                            ...
                            <ul className={contentStyle.ul2}>
                                <li className={contentStyle.tli2}>
                                    <img className={contentStyle.itemImgSize} src={artsy[48]?.imgUrl} alt="" />
                                    <p className={contentStyle.li}>
                                        {artsy[48]?.artist}
                                        <p className={contentStyle.titleText}>{`${artsy[48]?.title} / ${artsy[48]?.date}`}</p>
